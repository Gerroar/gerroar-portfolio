...
import MobNavBar from './components/NavBar/MobNavBar/MobNavBar'
...
function App() {
  ...
  useEffect(() => {
    const handleResizeWidthWindow = () => setWidth(window.innerWidth);
    //Subscribe to window resize event "onComponentDidMount"
    window.addEventListener("resize", handleResizeWidthWindow);
    return () => {
      //Unsuscribe "onComponentDestroy"
      window.removeEventListener("resize", handleResizeWidthWindow);
    }
  }, [])
  if (width > breakPoint) {
    return (
